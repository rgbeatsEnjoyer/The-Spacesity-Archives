...
star = pygame.image.load('starobjectv1.png').convert_alpha()
...
while True: 
    ...
    if gameStart:
        ...
        if count >= 1200:
            # Every (number) frames
            b = b + round(blockSize/5)

            d = d + round(blockSize/6)

            f = f + round(blockSize/7)
...
- Re-design graphics and characters/objects
- Balance sprite movement compared to enemy movement
